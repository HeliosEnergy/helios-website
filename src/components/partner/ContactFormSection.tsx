          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-sm text-base text-white bg-white/5 focus:outline-none focus:ring-1 transition-colors placeholder:text-white/40 ${
                    errors.name
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-white/20 rounded-sm text-base text-white bg-white/5 focus:outline-none focus:ring-1 focus:ring-white/40 transition-colors placeholder:text-white/40"
                />
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2 border border-white/20 rounded-sm text-base text-white bg-white/5 focus:outline-none focus:ring-1 focus:ring-white/40 transition-colors resize-vertical placeholder:text-white/40"
              />
            </div>
