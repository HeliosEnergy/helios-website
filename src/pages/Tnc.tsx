            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-white/80 mb-4">
                  By accessing or using the services provided by Helios Cloud, Inc. (&quot;Helios&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), you agree to be bound by these Terms and Conditions (&quot;Terms&quot;). These Terms constitute a legally binding agreement between you, an individual user or entity, and Helios regarding your use of our website, services, and any related applications or platforms.
                </p>
              ...
              <section>
                ...
                <ul className="list-disc pl-8 text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-white">4. User Responsibilities and Conduct</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-white">6. Payment Terms and Billing</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-white">10. Term and Termination</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-white">13. Entire Agreement</h2>
                <p className="text-white/80">
